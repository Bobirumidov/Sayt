...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-white/70 backdrop-blur-md">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-corporate-dark mb-6">
              {t('about.title')}
            </h2>
            ...
            <a href="#" className="inline-block bg-corporate-dark/85 backdrop-blur-md hover:bg-corporate-blue/85 backdrop-blur-md text-white px-8 py-3 rounded-md font-medium transition-colors">
              {t('about.more')}
            </a>
          </motion.div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="w-full lg:w-1/2 relative min-h-[300px]"
          >
